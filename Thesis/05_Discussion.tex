...
When examining the previously presented comparison (see \Cref{subsec:ResultsRequirements} on \pageref{subsec:ResultsRequirements}) of the various FL Solutions, the following can be noted.
% GPU 
